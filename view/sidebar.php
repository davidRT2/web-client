    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="../view/index.php" class="brand-link">
            <img src="../asset/polines.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">POLINES Data Master</span>
        </a>
